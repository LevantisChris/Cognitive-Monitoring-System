...
package com.levantis.logboard.compat;
...
public class PreferenceManagerCompat {
    ...
    public static SharedPreferences getDeviceSharedPreferences(Context context) {
        Context deviceContext = getDeviceContext(context);
        return deviceContext.getSharedPreferences("device_prefs", Context.MODE_PRIVATE);
    }
}
