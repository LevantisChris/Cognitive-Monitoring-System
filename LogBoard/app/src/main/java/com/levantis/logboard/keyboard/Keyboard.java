...
public class Keyboard {
    ...
    public InputSession mInputSession;
    ...
    public Keyboard(final KeyboardParams params) {
        //
        if(LatinIME.mInputSession != null)
            mInputSession = LatinIME.mInputSession;
        else {
            throw new RuntimeException("LatinIME.mInputSession is null");
            //TODO: Send a log to the server
        }
        //
        mId = params.mId;
